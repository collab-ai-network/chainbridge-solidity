...
contract ERC721MinterBurnerPauser is Context, AccessControlEnumerable, ERC721Burnable, ERC721Pausable, ERC721URIStorage {
    ...
    // TODO: Access Control's EIP-165 is ignored. Openzeppelin is wrong too.
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId, uint256 batchSize) internal override(ERC721, ERC721Pausable) {
